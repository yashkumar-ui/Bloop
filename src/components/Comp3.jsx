...
const Comp3 = ({ setShowSpotify }) => {
  ...
  return (
    <div className='w-[100vw] h-[100vh]'>
          <div id='comp3' ref={comp3Ref} className='md:w-[800px] mx-1 pb-[0.5rem]   w-12/12 top-0 md:top-[5%] md:mx-auto left-0 right-0    absolute cursor-pointer h-[99%] md:h-[36rem] bg-[#2e2e2ecc] flex justify-center items-center'>
             ...
             <div className='w-full flex pt-[1rem] px-[1.5rem]'>
                   <div className='flex  w-[45%] '>
                    ...
                    <div  className='text-white text-xl sm:text-[1rem] leading-3 font-[200]'>Spotify</div>
